...
export default () => (
  <Canvas>
    <XR>
      <ExposeBanners />
      <ZestyBanner adUnit='00000000-0000-0000-0000-000000000000' format='medium-rectangle' position={[0, 2, 0]} height={4} beacon={false} customDefaultImage={'https://picsum.photos/300/250'} customDefaultCtaUrl={'https://www.example.com'} modalTrigger={'lose'} modalDelay={5000} />
