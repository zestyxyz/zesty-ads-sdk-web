...
test.beforeEach(async ({ page }) => {
  await page.goto('http://localhost:8080/tests/babylonjs-vite/dist/');
});

test.describe('Babylon.js Vite/TypeScript - Initial load', () => {
  test('The correct test page is currently loaded', async ({ page }) => {
    await expect(page).toHaveTitle('Babylon.js Vite TypeScript Test');
  });
  ...
  test('All 3 banners are currently loaded', async ({ page }) => {
    ...
    expect(meshesLength).toBe(7);
  });
});

test.describe('Babylon.js Vite/TypeScript - Default banners', () => {
...
test.describe('Babylon.js Vite/TypeScript - Navigation', () => {
  test('Clicking the banner navigates to a new page', async ({ page, context }) => {
    ...
    expect(title).not.toBe('Babylon.js Vite TypeScript Test');
  });
});

test.describe('Babylon.js Vite/TypeScript - Prebid', () => {
