...
ZestyBanner.prototype.loadBanner = async function() {
    const activeBanner = await fetchCampaignAd(this.adUnitId, FORMATS[this.format], 'standard', this.customDefaultImage, this.customDefaultCtaUrl);
    ...
    if (this.modalTrigger) {
      ...
      document.addEventListener(this.modalTrigger, modalTriggers[this.adUnitId]);
    }
